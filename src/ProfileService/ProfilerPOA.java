 ...
 implements ProfileService.ProfilerOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("getRestaurantProfile", new java.lang.Integer (5));
  }
  ...
  /* Return a list of top three foods that have the highest number of orders in hte zone.
       ...
       case 4:  // ProfileService/Profiler/getUserProfile
       {
         String user_id = in.read_string ();
         ProfileService.UserProfile $result = null;
         $result = this.getUserProfile (user_id);
         out = $rh.createReply();
         ProfileService.UserProfileHelper.write (out, $result);
         break;
       }

       case 5:  // ProfileService/Profiler/getRestaurantProfile
       {
         String restaurant_id = in.read_string ();
         ProfileService.RestaurantProfile $result = null;
         $result = this.getRestaurantProfile (restaurant_id);
         out = $rh.createReply();
         ProfileService.RestaurantProfileHelper.write (out, $result);
         break;
       }
