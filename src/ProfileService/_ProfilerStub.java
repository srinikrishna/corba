...
public class _ProfilerStub extends org.omg.CORBA.portable.ObjectImpl implements ProfileService.Profiler
{
  ...
  public ProfileService.UserProfile getUserProfile (String user_id)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                $out.write_string (user_id);
                $in = _invoke ($out);
                ProfileService.UserProfile $result = ProfileService.UserProfileHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
  ...
  public ProfileService.RestaurantProfile getRestaurantProfile (String restaurant_id)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getRestaurantProfile", true);
                $out.write_string (restaurant_id);
                $in = _invoke ($out);
                ProfileService.RestaurantProfile $result = ProfileService.RestaurantProfileHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                ...
                return getRestaurantProfile (restaurant_id        );
            } finally {
                _releaseReply ($in);
            }
